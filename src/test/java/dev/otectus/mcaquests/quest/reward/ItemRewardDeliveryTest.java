...
class ItemRewardDeliveryTest {
    ...
    private static final ResourceLocation ITEM = ResourceLocation.fromNamespaceAndPath("minecraft", "emerald");
    ...
    @Test void absentItemsDoNotLoseDebtOrStarveRestoredItems() {
        PendingItemRewards pending = new PendingItemRewards();
        for (int i = 0; i < 17; i++) {
            pending.add(ResourceLocation.fromNamespaceAndPath("absent", "item_" + i), 64);
        }
        pending.add(ITEM, 64);
