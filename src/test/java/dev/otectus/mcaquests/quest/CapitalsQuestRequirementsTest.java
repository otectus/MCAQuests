...
class CapitalsQuestRequirementsTest {
    ...
    void missingCourtPackAndSyntheticSituationAreAttributedToCapitals() {
        ...
        for (ResourceLocation id : new ResourceLocation[] {
                new ResourceLocation("mcaquests", "compat/capitals/royal_escort"),
                SituationIds.syntheticId(new ResourceLocation("mcaquests", "capitals_drums_of_war")),
                SituationIds.syntheticId(new ResourceLocation("mcaquests", "capitals_the_empty_throne"))
        }) assertEquals(new CapitalsCompat().displayName(), QuestManager.compatSuspensionSubject(id).orElseThrow());
        assertFalse(CapitalsQuestRequirements.isBundled(new ResourceLocation("test", "compat/capitals/custom")));
        assertTrue(QuestManager.compatSuspensionSubject(new ResourceLocation("test", "ordinary")).isEmpty());
    }
}
