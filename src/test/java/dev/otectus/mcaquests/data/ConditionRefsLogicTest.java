...
class ConditionRefsLogicTest {
    private final QuestCompletedCondition a = new QuestCompletedCondition(ResourceLocation.fromNamespaceAndPath("test", "a"), HistoryScope.GLOBAL);
    private final QuestCompletedCondition b = new QuestCompletedCondition(ResourceLocation.fromNamespaceAndPath("test", "b"), HistoryScope.GLOBAL);
