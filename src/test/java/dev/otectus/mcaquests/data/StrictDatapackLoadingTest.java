...
class StrictDatapackLoadingTest {
    ...
    private static final ResourceLocation FILE = ResourceLocation.fromNamespaceAndPath("test", "folder/source");
    private static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath("test", "declared");
