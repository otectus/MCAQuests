...
class ProjectFailureTest {
    private static ProjectState state() {
        ProjectState state = new ProjectState(ResourceLocation.fromNamespaceAndPath("test", "project"), ProjectScope.VILLAGE,
                "v:1", ResourceLocation.fromNamespaceAndPath("minecraft", "overworld"), BlockPos.ZERO, OptionalInt.of(1), 100, 1);
    ...
    @Test void legacyProjectsGetAFreshDeadlineWithoutLosingContributions() {
        ProjectState legacy = new ProjectState(ResourceLocation.fromNamespaceAndPath("test", "project"), ProjectScope.VILLAGE,
                "v:1", ResourceLocation.fromNamespaceAndPath("minecraft", "overworld"), BlockPos.ZERO, OptionalInt.of(1), 100, 1);
