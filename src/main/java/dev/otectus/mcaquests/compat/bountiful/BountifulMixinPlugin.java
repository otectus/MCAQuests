...
public final class BountifulMixinPlugin implements IMixinConfigPlugin {
     ...
     *
     * <p>The first shape used to be missing here, and it is the shape Mixin actually emits for a
    ...
    /** Whether NeoForge has a mod file for Bountiful at all. Any throw reads as "no". */
