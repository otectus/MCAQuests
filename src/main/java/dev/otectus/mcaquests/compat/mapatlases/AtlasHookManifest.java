...
/** Exact Forge 6.0.20 bytecode contract. Minecraft anchors allow official and production SRG names. */
public final class AtlasHookManifest {
    public static final String VERSION = "1.20-6.0.20";
    public static final String TARGET = "pepjebs.mapatlases.client.AbstractAtlasWidget";
    ...
    public static final String MAP_RENDER = "(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;ILnet/minecraft/world/level/saveddata/maps/MapItemSavedData;ZI)V";
