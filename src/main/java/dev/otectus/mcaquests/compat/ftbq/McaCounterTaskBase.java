...
public abstract class McaCounterTaskBase extends Task {
    ...
    /**
     * The submitting player's current progress toward {@link #count}, e.g. a summed completion
     * count. May throw; {@link #submitTask} wraps it in the fail-safe contract and defaults to
     * {@code 0} on any {@link Throwable}.
     */
