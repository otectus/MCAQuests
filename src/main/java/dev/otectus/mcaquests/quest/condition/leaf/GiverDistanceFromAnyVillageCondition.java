...
public record GiverDistanceFromAnyVillageCondition(double minDistance) implements QuestCondition {
    ...
    public static final Codec<GiverDistanceFromAnyVillageCondition> CODEC =
            ...
            .flatXmap(GiverDistanceFromAnyVillageCondition::validate, GiverDistanceFromAnyVillageCondition::validate).codec();
