...
public final class RewardTypes {
    ...
    public static final QuestRewardType<ItemPoolReward> ITEM_POOL =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "item_pool"), ItemPoolReward.CODEC);
    ...
    public static final QuestRewardType<CapitalTitleReward> CAPITAL_TITLE =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "capital_title"), CapitalTitleReward.CODEC);
    public static final QuestRewardType<CapitalChronicleReward> CAPITAL_CHRONICLE =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "capital_chronicle"),
                    CapitalChronicleReward.CODEC);
    public static final QuestRewardType<CapitalVillagerTitleReward> CAPITAL_VILLAGER_TITLE =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "capital_villager_title"),
