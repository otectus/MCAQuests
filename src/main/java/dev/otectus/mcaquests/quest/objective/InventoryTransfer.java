...
public final class InventoryTransfer {
     ...
     * no enchantments. Damage deliberately does not count — a worn pillager crossbow is ordinary stock,
     * and refusing it is exactly the bug that made a two-crossbow delivery impossible to finish.
     */
    public static boolean isPlain(ItemStack stack) {
        return !stack.hasCustomHoverName() && !stack.isEnchanted();
    }
