 ...
 * {@link #register(ResourceLocation, MapCodec)} (re-exported through the public API in Phase 6).
 */
public final class ObjectiveTypes {
    ...
    public static final QuestObjectiveType<TownsteadStateObjective> TOWNSTEAD_STATE =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "townstead_state"), TownsteadStateObjective.CODEC);
    public static final QuestObjectiveType<TownsteadChangeObjective> TOWNSTEAD_CHANGE =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "townstead_change"), TownsteadChangeObjective.CODEC);
    public static final QuestObjectiveType<TownsteadProfessionProgressObjective> TOWNSTEAD_PROFESSION_PROGRESS =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "townstead_profession_progress"),
    ...
    public static final QuestObjectiveType<TownsteadBuildingRegisteredObjective> TOWNSTEAD_BUILDING_REGISTERED =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "townstead_building_registered"),
    ...
    public static final QuestObjectiveType<TownsteadSpiritProgressObjective> TOWNSTEAD_SPIRIT_PROGRESS =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "townstead_spirit_progress"),
    ...
    public static final QuestObjectiveType<TownsteadHealthyResidentsObjective> TOWNSTEAD_HEALTHY_RESIDENTS =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "townstead_healthy_residents"),
    ...
    public static final QuestObjectiveType<TownsteadScheduleStreakObjective> TOWNSTEAD_SCHEDULE_STREAK =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "townstead_schedule_streak"),
    ...
    public static final QuestObjectiveType<UseItemObjective> USE_ITEM =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "use_item"), UseItemObjective.CODEC);
    /**
    ...
    public static final QuestObjectiveType<InteractBlockObjective> INTERACT_BLOCK =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "interact_block"),
                    InteractBlockObjective.CODEC);
    /**
    ...
    public static final QuestObjectiveType<BountifulBountiesObjective> BOUNTIFUL_BOUNTIES =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "bountiful_bounties"),
    ...
    public static final QuestObjectiveType<FindMissingRelativeObjective> FIND_MISSING_RELATIVE =
            register(ResourceLocation.fromNamespaceAndPath(McaQuests.MOD_ID, "find_missing_relative"), FindMissingRelativeObjective.CODEC);
    ...
    public static <T extends QuestObjective> QuestObjectiveType<T> register(ResourceLocation id, MapCodec<T> codec) {
