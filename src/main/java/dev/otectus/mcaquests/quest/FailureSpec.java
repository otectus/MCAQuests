...
public record FailureSpec(Optional<Integer> deadlineTicks,
    ...
    public static final Codec<FailureSpec> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            StrictCodecs.strictOptional(ExtraCodecs.POSITIVE_INT, "deadline_ticks").forGetter(FailureSpec::deadlineTicks),
            StrictCodecs.strictOptional(Codec.intRange(0, (int) DAY_LENGTH), "deadline_time").forGetter(FailureSpec::deadlineTimeOfDay),
            StrictCodecs.strictOptional(WeatherCondition.Weather.CODEC, "require_weather").forGetter(FailureSpec::requireWeather),
            StrictCodecs.strictOptional(Codec.BOOL, "fail_on_giver_death", false).forGetter(FailureSpec::failOnGiverDeath),
            StrictCodecs.strictOptional(Codec.INT, "failure_hearts", 0).forGetter(FailureSpec::failureHearts),
            StrictCodecs.strictOptional(ExtraCodecs.NON_NEGATIVE_INT, "retry_after").forGetter(FailureSpec::retryAfterTicks),
            StrictCodecs.strictOptional(Codec.BOOL, "block_retry", false).forGetter(FailureSpec::blockRetry),
            ...
            StrictCodecs.strictOptional(Codec.BOOL, "fail_on_target_lost", false).forGetter(FailureSpec::failOnTargetLost)
