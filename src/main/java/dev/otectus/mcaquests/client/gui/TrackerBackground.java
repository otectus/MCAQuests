 ...
 *
 * <p>Deliberately free of Minecraft, Mojang and NeoForge types — including the config class, which would
 * drag in {@code ModConfigSpec} — so it can be exercised by a plain JUnit test with no game
